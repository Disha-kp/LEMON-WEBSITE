...
?>
	<div class="main-header">
		...
		<div class="logo">
    		<a href="index.php">
        <h2 style="font-family: 'Kavoon', serif; font-weight: 400; font-size:70px;font-style: normal; color:rgba(5, 5, 5, 0.3); text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.3); margin: 0; padding: 0; ">
            Lemon
        </h2>
    		</a>
			</div>
...
<!-- ============================================================= SEARCH AREA : END ============================================================= -->				</div><!-- /.top-search-holder -->
				...
				<div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row" style="margin-left:80%;">
